...
, vulkanLayers ? /* lib.optionals (!stdenv.isDarwin) [ "device-select" "overlay" "intel-nullhw" ] # No Vulkan support on Darwin */ [] # SteamOS mesa-radv
, OpenGL, Xplugin
, withValgrind ? lib.meta.availableOn stdenv.hostPlatform valgrind-light && !valgrind-light.meta.broken, valgrind-light
, enableGalliumNine ? /* stdenv.isLinux */ false # SteamOS mesa-radv
...
self = stdenv.mkDerivation {
  ...
  src = fetchFromGitHub {
    ...
    repo = "mesa";
    rev = jupiterVersion;
    hash = "sha256-bdSYX7nLka/+MAZJJ6HkfMXOrHjRFTJm3qj4c9CE+QI=";
  };
  ...
  mesonFlags = [
    ...
    */
    ...
    ++ /* SteamOS mesa-radv */ [
      ...
      #"-Dvalgrind=enabled"
      "-Dradv-build-id=807f05b230950888f262a43c09d90c13bf665204"
    ]
  ;
  ...
  postFixup = lib.optionalString stdenv.isLinux ''
    ...
    [ -f "$dev/lib/pkgconfig/dri.pc" ] && substituteInPlace "$dev/lib/pkgconfig/dri.pc" --replace "$drivers" "${libglvnd.driverLink}"
